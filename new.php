...
<div class="col-lg-10">
<form class="well" action="newcheck.php" method="POST" name="myForm">
  <fieldset>
    <legend>New</legend>
    ...
    <div class="form-group">
      ...
      <button type="submit" class="btn btn-primary" onclick="">creative</button>
...
?>
    <div class="form-group">
      <div class="col-lg-10 " align="center">
    <a href="management.php" class="text1">Back</a>
